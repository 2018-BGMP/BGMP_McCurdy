...
ggplot(data = acchain, aes(x = combos, y = value, fill = combos)) + geom_boxplot() + scale_fill_manual(values = c("#F8766D", "#F8766D", "#A3A500", "#00BF7D", "#00B0F6", "#F8766D", "#A3A500", "#00BF7D", "#00B0F6")) + theme_classic() + theme(legend.position = "None") + labs(y = "log(lipid mass (pmol))", title = "Acylcarnitine")  + xlab("") + scale_x_discrete(labels = lenlabs) + 
